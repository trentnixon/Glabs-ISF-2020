...
const Section6 = ()=>{
    ...
    useEffect(()=>{
        ...
        Panels.fromTo(Project1, {yPercent:20, opacity:0, duration:2,ease: EaseThis},{yPercent:0, opacity:1, duration:2,ease: EaseThis})
        .fromTo(Project2, {yPercent:-20, opacity:0, duration:2,ease: EaseThis},{yPercent:0, opacity:1, duration:2,ease: EaseThis},"-=1")
        .fromTo(Project3, {yPercent:20, opacity:0, duration:2,ease: EaseThis},{yPercent:0, opacity:1, duration:2,ease: EaseThis},"-=1")
        .fromTo(Project4, {yPercent:-20, opacity:0, duration:2,ease: EaseThis},{yPercent:0, opacity:1, duration:2,ease: EaseThis},"-=1")
        /*
